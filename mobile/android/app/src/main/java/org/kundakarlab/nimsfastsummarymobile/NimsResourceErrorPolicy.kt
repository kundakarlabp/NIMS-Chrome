...
/**
 * Filters WebView load failures down to actual page/frame navigation candidates.
 * Legacy NIMS pages routinely reference missing CSS/JS/font/image assets; those
 * failures are noisy but do not identify why frmMainMenu stayed blank.
 */
