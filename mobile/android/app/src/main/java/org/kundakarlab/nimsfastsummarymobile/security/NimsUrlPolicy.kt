...
object NimsUrlPolicy {
    ...
    fun isAllowed(uri: Uri): Boolean = isAllowedParts(uri.scheme, uri.host, uri.userInfo, uri.path.orEmpty(), uri.port)
    ...
    private fun isAllowedParts(scheme: String?, host: String?, userInfo: String?, path: String, port: Int): Boolean {
