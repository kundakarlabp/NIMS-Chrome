...
Android version 0.10.3 uses a browser-first WebView with on-device report processing. Login remains manual; report parsing begins only after the clinician taps Quick Review.
...
3. Open **Artifacts**.
4. Download `nims-results-0.10.3-debug-apk`.
